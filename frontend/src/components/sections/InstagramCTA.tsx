    ...
    <section ref={containerRef} className="py-24 px-6 sm:px-12 w-full max-w-7xl mx-auto flex flex-col gap-12 overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:h-[900px] md:overflow-hidden relative pb-12 md:pb-0">
        ...
        <motion.div style={{ y: y1 }} className="flex flex-col gap-6">
          <div className="relative group w-full h-[400px] md:h-[500px] bg-void overflow-hidden">
            <div className="absolute inset-0 bg-[url('/images/tattoo_1_1783205846206.png')] bg-cover bg-center mix-blend-luminosity grayscale group-hover:grayscale-0 transition-all duration-700 group-hover:scale-105" />
